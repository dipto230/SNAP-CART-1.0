...
function OrderSuccess() {
  return (
      <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
          ...
          >
              Thank you for shopping with us! Your order has been placed and is being proceed.
              You can track progress in your
...
>
  ...
  <div className='absolute top-24 left-[50%] w-2 h-2 bg-green-40 rounded-full animate-bounce' />
  <div className='absolute top-16 left-[70%] w-2 h-2 bg-green-40 rounded-full animate-pulse' />
</motion.div>
      </div>
