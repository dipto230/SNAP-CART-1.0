...
function Login() {
  ...
  >
      {loading?<Loader2 className='w-5 h-5 animate-spin'/>:"Login"}
          ...
          <p className=' cursor-pointer text-gray-600 mt-6 text-sm flex items-center gap-1' onClick={()=>router.push("/register")}>Want to create an account? <LogIn className='w-4 h-4'/><span className='text-blue-50'>Sign Up</span></p>
